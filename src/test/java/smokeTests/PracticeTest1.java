...
public class PracticeTest1 extends BaseTest {
  ...
  public void verifyInvalidLogin2() throws InterruptedException, IOException {
    LoginPage loginPage = new LoginPage(getDriver());
    String username = ExcelReader.getCellValue(Constants.XLS_PATH, Constants.LOGIN_SHEET, 1, 0);
    String password = ExcelReader.getCellValue(Constants.XLS_PATH, Constants.LOGIN_SHEET, 1, 1);
    loginPage.verifyInvalidLogin(username, password);
  }
  ...
  public void verifyInvalidLogin3() throws InterruptedException, IOException {
    LoginPage loginPage = new LoginPage(getDriver());
    String username = ExcelReader.getCellValue(Constants.XLSX_PATH, Constants.LOGIN_SHEET, 1, 0);
    String password = ExcelReader.getCellValue(Constants.XLSX_PATH, Constants.LOGIN_SHEET, 1, 1);
    loginPage.verifyInvalidLogin(username, password);
  }

  @Test(priority = 5)
  public void verifyInvalidLogin4() throws InterruptedException, IOException {
    LoginPage loginPage = new LoginPage(getDriver());
