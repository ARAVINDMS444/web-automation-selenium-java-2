...
public class SeleniumActions extends BaseTest {
  ...
  public void openUrl(String url) {
    ...
    actionsUtil = new ActionsUtil(getDriver());
  }
  ...
  public void testExplicitWaits() {
    ...
    WebElement successText =
        wait.until(
            ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[text()='Liftoff!']")));
        ...
        WebElement text =
            wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("//strong[normalize-space()='Start learning']")));
  ...
  public void testFileDownload() {
    ...
    WebElement downloadLink =
        getDriver().findElement(By.xpath("//a[contains(@class, 'download-on-click')]"));
    downloadLink.click();
    actionsUtil.downloadFile(System.getProperty("download.dir"), "downloadedFile", 5000);
  }
  ...
  public void testFileUpload() {
    ...
    getDriver()
        ...
        .sendKeys(System.getProperty("user.dir") + "/test-artifacts/uploads/test.pdf");
  ...
  public void testAccordions() {
    ...
    getDriver()
        .findElement(By.xpath("//summary[contains(@class,'accordion-item__title')]"))
        .click();
    WebElement accordionText =
        getDriver().findElement(By.xpath("//p[normalize-space()='This is an accordion item.']"));
